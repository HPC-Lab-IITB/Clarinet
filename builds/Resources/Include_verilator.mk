...
RTL_GEN_DIRS = -vdir Sim_RTL  -bdir build_dir  -info-dir build_dir
...
cpu:  build_dir  CPU_RTL
	...
	@for f in $(shell ls CPU_RTL); do cp Sim_RTL/$${f} CPU_RTL/$${f}; done
	@echo  "INFO: Copied Sim_RTL into CPU_RTL"
