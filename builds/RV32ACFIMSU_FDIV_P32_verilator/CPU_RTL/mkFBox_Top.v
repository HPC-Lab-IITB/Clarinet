...
module mkFBox_Top(verbosity,
  ...
  wire [63 : 0] fbox_core$req_v1,
		...
		fbox_core$req_v3,
		fbox_core$word_fst;
  wire [31 : 0] fbox_core$req_pv1, fbox_core$req_pv2;
  ...
  mkFBox_Core fbox_core(.verbosity(verbosity),
			...
			.req_pv1(fbox_core$req_pv1),
			.req_pv2(fbox_core$req_pv2),
  ...
  assign fbox_core$req_pv1 = req_pv1 ;
  assign fbox_core$req_pv2 = req_pv2 ;
